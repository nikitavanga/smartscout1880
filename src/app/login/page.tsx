                    ...
                    <div className="flex flex-col justify-center space-y-5">
                        ...
                        <div className="grid gap-3 sm:grid-cols-3">
                            <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4">
                                ...
                                <p className="mt-1 text-xs text-slate-400">Current event and match visibility</p>
                            </div>
                            <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4">
                                <p className="text-sm font-medium">Scheduler</p>
                                <p className="mt-1 text-xs text-slate-400">Scoutradioz-style assignment flow</p>
                            </div>
                            <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4">
                                <p className="text-sm font-medium">Summaries</p>
                                <p className="mt-1 text-xs text-slate-400">Pre-match and post-match evidence cards</p>
                            </div>
                        </div>
                    </div>
